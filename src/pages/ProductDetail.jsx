...
const ProductDetail = () => {
  ...
  useEffect(() => {
    console.log("initial product", initialProducts);
  ...
  return (
    <>
      <div
        className="container mx-auto px-4 md:px-8 bg-gray-900 min-h-screen rounded-2xl
      my-8 p-6 md:p-12 border border-gray-800 "
      >
        <Link to={"/"}>
          <button
            className=" cursor-pointer flex items-center text-gray-400 hover:text-orange-400 transition duration-150
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-1 ">
          <div className="w-full">
            ...
            rounded-2xl shadow-2xl shadow-gray-900/50 border-4 border-gray-800"
            />
          </div>
          <div className="flex flex-col justify-between ">
            ...
            <h2
              className="text-xl font-bold text-gray-200 mb-2 border-b border-e-orange-900/50
          pb-2 flex items-center space-x-2"
            ...
            <ul
              className="space-y-3 text-gray-300 p-4 bg-gray-800 rounded-xl border 
            border-gray-700"
            >
            ...
            <div className="mt-5 space-y-4 flex justify-center items-center flex-col">
              ...
              <Link
                ...
                className="w-full py-3 border-2 border-orange-600 text-orange-400 font-bold rounded-full 
                       cursor-pointer hover:bg-orange-900/50 transition duration-300
