  ...
  return (
    <>
      <div className="container mx-auto md:px-8 pt-12 ">
        <div
          className="p-12 bg-gray-900 rounded-3xl shadow-2xl max-w-2xl mx-auto
     text-center mt-12 border border-green-700 text-white"
        >
          ...
          <div
            className="p-6 bg-green-900/30 border-greeen-700 rounded-xl font-mono text-left inline-block 
        text-green-300 text-sm"
          ...
          <Link
            to={"/"}
            className=" mt-10 px-10 py-4 bg-orange-600 text-white font-extrabold  rounded-full 
